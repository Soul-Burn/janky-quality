...
return {
    ...
    ["inserter"] = m.default_mod { "rotation_speed", "extension_speed" },
    ...
    ["beacon"] = m.mod { energy_usage = m.mult(-0.12) },
    ...
    ["battery-equipment"] = m.default_mod { "energy_source.buffer_capacity" },
    ["accumulator"] = m.default_mod { "energy_source.buffer_capacity" },
